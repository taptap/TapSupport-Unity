...
namespace TapTap.Support {
    public class TapSupport {
        ...
        public static Task<string> GetSupportWebUrl(string pathAndQuery = null,
            ...
            Uri rawUri = new Uri($"{serverUrl}/in-app/v1/products/{productId}{pathAndQuery}");
            NameValueCollection queryPairs = UrlUtils.ParseQueryString(rawUri.Query);
            queryPairs["lang"] = TapLocalizeManager.GetCurrentLanguageString2();

            NameValueCollection fragmentPaires = new NameValueCollection();
            fragmentPaires.Set(authData.Fragment.Key, authData.Fragment.Value);
            ...
            if (totalFields.Count > 0) {
                fragmentPaires["fields"] = JsonConvert.SerializeObject(totalFields);
            }
            ...
            UriBuilder builder = new UriBuilder {
                ...
                Query = UrlUtils.ToQueryString(queryPairs),
                Fragment = UrlUtils.ToQueryString(fragmentPaires),
            };
