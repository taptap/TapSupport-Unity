...
namespace TapTap.Support {
    public class TapSupport {
        ...
        public static Task<string> GetSupportWebUrl(string pathAndQuery = null,
            ...
            NameValueCollection queryPairs = ParseQueryString(rawUri.Query);
            ...
            if (totalFields.Count > 0) {
                queryPairs["fields"] = Uri.EscapeDataString(JsonConvert.SerializeObject(totalFields));
            }
            ...
            UriBuilder builder = new UriBuilder {
                ...
                Query = ToQueryString(queryPairs),
                Fragment = authData.Fragment
            };
